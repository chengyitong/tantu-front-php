		...
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_view_switch">' +
							...
							'<input type="radio" id="'+obj.id+'_view_thumbs" name="view_mode_'+obj.id+'" /> <label class="plupload_button"  for="'+obj.id+'_view_thumbs" data-view="thumbs">' + _('缩略图') + '</label>' +
						'</div>' +
					'</div>' +
				'</div>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("把文件拖到这里") + '</div>' +
...
$.widget("ui.plupload", {
	...
	*/
	...
	_handleState: function() {
		...
		if (up.state === plupload.STARTED) {//  开始上传
			$(this.start_button).button('disable');
			$([])
				.add(this.stop_button)
				.add('.plupload_started')
					.removeClass('plupload_hidden');
			$('.plupload_upload_status', this.element).html(o.sprintf(_('已上传 %d/%d 个文件'), up.total.uploaded, up.files.length));
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', this.browse_button).html(_('添加文件'));
		} else {
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('已选择 %d 个文件'), up.total.queued));
		}
		up.refresh();
	},
	...
	_updateTotalProgress: function() {
		...
		this.element
			...
			.find('.plupload_upload_status')
				.html(o.sprintf(_('已上传 %d/%d 个文件'), up.total.uploaded, up.files.length));
	},
