...
<script src="/static/plugs/touchslider.js"></script>
<script>
$(function(){
	var w = $('.ui-content').width();
	var h = w*0.5625;
	$(".touchslider-demo").touchSlider({mouseTouch:true,widths:w,heights:h});
});
</script>
<div class="touchslider-demo" data-r="a">
	<div class="touchslider-viewport"><div style="width:10000px">
		<div class="touchslider-item"><img src="http://www.bookon.com.cn/static/images/IMG_0669.jpg" ></div>
		<div class="touchslider-item"><img src="http://www.bookon.com.cn/static/images/IMG_0722.jpg"></div>
		<div class="touchslider-item"><img src="http://www.bookon.com.cn/static/images/IMG_0725.jpg" ></div>
	</div></div>
...
(function($, undefined) {
	window.touchSlider = function(options) {
		...
		options = $.extend({
			...
			//set css
			$(container).css('width',options.widths);
			$(options.viewport).css('height',options.heights);
			$(options.viewport).css('width',options.widths);
			$("." + namespace + "-item img").css('width',options.widths);
			$("." + namespace + "-nav").css('width',options.widths);
		var ret = {
				current: 0,
				step: step,
				next: next,
