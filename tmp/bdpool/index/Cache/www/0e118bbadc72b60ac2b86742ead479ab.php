...
<div class="container1200 center bg5" style="height:860px">
  ...
  <div class="bg51 float">
    <div class="detailcon">
      ...
      <div class="detail2 float">
        <input type="text" class="form-control deinputtext" name="username" value="<?php echo ($data["user"]["username"]); ?>" <?php if($data['user']['username']!='') echo 'disabled="disabled"'; ?>  />
      </div>
    ...
    <div class="detailcon">
      ...
      <div class="detail2 float">
        <input type="text" class="form-control deinputtext" name="nickname" value="<?php echo ($data["user"]["nickname"]); ?>"  />
      </div>
    ...
    <div class="detailcon">
      ...
      <div class="detail2 float">
        <input type="text" class="form-control deinputtext " disabled="disabled" value="<?php echo ($data["user"]["realname"]); ?>" >
      </div>
      <div class="detail3 float">
        <h6><input type="checkbox" name="realname_show" value="1"<?php if(!$data['user']['realname_show']) echo ' checked'; ?> /><span style="padding-bottom:3px;">保密</span></h6>
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="detailcon">
      ...
      <div class="detail2 float">
        <!--<input type="text" class="form-control deinputtext" name="email" value="<?php echo ($data["user"]["email"]); ?>" disabled="disabled" >-->
      	<div class="float" style="width:179px;padding-top:10px;white-space: nowrap;text-overflow: ellipsis;overflow:hidden;" title="<?php echo ($data["user"]["email"]); ?>"><?php if(!$data['user']['email_v']) echo '<span style="color:red;">[待绑定] </span>'; echo ($data["user"]["email"]); ?></div> <br />
        <span data-toggle="modal" data-target="#bindingmailModal" style="color:#f16172;cursor:pointer;font-size:11px;" >邮箱绑定（绑定后可用作登录）</span>
      </div>
      <div class="detail3 float">
        <h6><input type="checkbox" name="email_show" value="1"<?php if(!$data['user']['email_show']) echo ' checked'; ?> /><span style="padding-bottom:3px;">保密</span></h6>
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="detailcon">
      ...
      <div class="detail2 float" style="padding:10px 0;width:179px;">
        <input type="text" class="form-control deinputtext" name="qq" value="<?php echo ($data["user"]["qq"]); ?>" style="display:none;" />
        <?php if($data['user']['3rdpartyid']!='288'): ?><span onclick="location='/static/qq.php?go=qqbind';" style="color:#f16172;cursor:pointer;font-size:11px;" >QQ绑定（绑定后可用作登录）</span>
        <?php else: ?><span onclick="if(confirm('确定取消绑定？')) location='/user/qqunbind';" style="color:#f16172;cursor:pointer;font-size:11px;" >取消绑定（绑定后可用作登录）</span>
        <?php endif; ?>
      </div>
      <div class="detail3 float" style="display:none;">
        <h6><input type="checkbox" name="qq_show" value="1"<?php if(!$data['user']['qq_show']) echo ' checked'; ?> /><span style="padding-bottom:3px;">保密</span></h6>
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="detailcon">
      ...
      <div class="detail2 float">
      <div class="float" style="width:179px;padding-top:10px;overflow:hidden;" title="<?php echo ($data["user"]["mobile"]); ?>"><?php echo ($data["user"]["mobile"]); ?></div><br />
        <span data-toggle="modal" data-target="#bindingModal" style="color:#f16172;cursor:pointer;font-size:11px;" >手机绑定（绑定后可用作登录）</span>
        
      </div>
      <div class="detail3 float">
      <h6><input type="checkbox" name="mobile_show" value="1"<?php if(!$data['user']['mobile_show']) echo ' checked'; ?> /><span style="padding-bottom:3px;">保密</span></h6>
      </div>
    </div>
    <div class="detailcon">
      <div class="detail1 float">电话：</div>
      <div class="detail2 float">
        <input type="text" class="form-control deinputtext" name="tel" value="<?php echo ($data["user"]["tel"]); ?>" >
      </div>
      <div class="detail3 float">
    ...
    <div class="detailcon">
      ...
      <div class="detail2 float"><input type="text" class="form-control deinputtext" name="desc" value="<?php echo ($data["user"]["desc"]); ?>" ></div>
    </div>
    <div class="detailcon">
      <div class="detail1 float">身份：</div>
      <div class="float">
      <?php $sf = D('syscode')->where('syscode_parentid=318 and syscode_isuse=1')->order('syscode_sortno')->select(); ?>
      <?php if(is_array($sf)): $i = 0; $__LIST__ = $sf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $sf_chk = ''; $sf_arr = explode(',',$data['user']['shenfen']); if(in_array($vo['syscode_id'],$sf_arr)) $sf_chk = 'checked'; ?>
        <input type="checkbox" name="sf[]" value="<?php echo ($vo["syscode_id"]); ?>" style="margin: 10px;" <?php echo ($sf_chk); ?> >
        <?php echo ($vo["syscode_name"]); endforeach; endif; else: echo "" ;endif; ?>
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="detailcon">
      ...
      <div class="float">
        <input type="radio" style="margin: 10px;" name="gander" value="1" <?php if($data['user']['gander']==1) echo 'checked="checked"'; ?> >
        男
        <input type="radio" style="margin: 10px;" name="gander" value="2" <?php if($data['user']['gander']==2) echo 'checked="checked"'; ?>>
        女</div>
      <div class="clearfix"></div>
    </div>
    <div class="detailcon">
      ...
      <div class="detail2 float">
        <input type="date" class="form-control deinputtext" name="birth" value="<?php echo ($data["user"]["birth"]); ?>" >
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="detailcon">
      ...
      <div style="margin-left: 85px;">
        ...
        <input type="hidden" name="address" id="address" value="<?php echo ($data["user"]["address"]); ?>" /><br />
      </div>
      <div class="clearfix"></div>
      <div class="detail1 float">自我介绍：</div>
      <div class="float" style="margin-top:4px;width:445px;margin-left:4px;">
        <textarea class="form-control " rows="5" id="introduce" name="introduce" placeholder=""><?php echo ($data["user"]["introduce"]); ?></textarea>
      </div>
      <div class="clearfix"></div>
  </form>
  ...
  <div class="dtimg" onClick="//$('#avatar1').click();" style="border:none;"><?php if($data['user']['avatar']==''){if($data['user']['avatarimg']==''){ ?><img id="avt" src="/static/images/uploadtx.jpg" width="160" /><?php }else{ ?><img src="<?php echo ($data["user"]["avatarimg"]); ?>" width="160" /><?php }}else{ ?><img id="avt" src="/static/uploadfiles/images/<?php echo ($data["user"]["avatar"]); ?>" width="160" /><?php } ?>
              ...
              <div class="mod21" style="height: auto;">
                ...
                <table height="36px" class="p-table">
                    <tr >
                        ...
                        <td style="width:233px;text-align: left;"><?php echo ($data["user"]["mobile"]); ?></td>
                    </tr>
                    <tr><td><br></td></tr>
                    <tr>
              ...
              <div class="mod21" style="height: auto;">
                ...
                <table height="36px" class="p-table">
                    <tr >
                        ...
                        <td style="width:233px;text-align: left;"><?php echo ($data["user"]["email"]); ?></td>
                    </tr>
                    <tr><td><br></td></tr>
                    <tr>
