...
<div class="container1200 center padding_b">
  ...
  <!--
    <div  class="hpage1">
    <div class="hpage11"><p>余额</p><p>$0.00</p></div>
    <div class="hpageimg"><img src="../../../../static/images/line1.png" width="2px" height="68px" /></div>
    <div class="hpage11"><p>已冻结</p><p>$0.00</p></div>
    <div class="hpageimg"><img src="../../../../static/images/line1.png" width="2px" height="68px" /></div>
    <div class="hpage11"><p>可提取</p><p>$0.00</p></div>
    <div class="hpageimg"> <img src="../../../../static/images/line1.png" width="2px" height="68px" /></div>
    <div class="hpagebtn"></div>
    <div class="hpagebtn1"><button type="submit" class="btn btn6 bgc">充值</button></div>
    <div class="hpagebtn1"><button type="submit" class="btn btn6 bgc">提现</button></div>
     <div class="clearfix"></div>
    </div>
    -->
    
    <div class="hpage2">
    <a href="/user/homepage_pending"><div class="hpage2txt"><div class="hpage2txt2"> <p>待处理作品</p><p><?php echo ($data["num1"]); ?></p></div></div></a>
    <a href="/user/homepage_pending?status=0"><div class="hpage2txt "><div class="hpage2txt2"><p>待审核作品</p><p><?php echo ($data["num2"]); ?></p></div></div></a>
    <a href="/user/homepage_pending?status=-1"><div class="hpage2txt"><div class="hpage2txt2"><p>未通过作品</p><p><?php echo ($data["num3"]); ?></p></div></div></a>
    <a href="/user/homepage_pending?status=1"><div class="hpage2txt"><div class="hpage2txt2"><p>已发布作品</p><p><?php echo ($data["num4"]); ?></p></div></div></a>
    <div class="clearfix"></div>
    </div>
    <br /><br /><br /><br />
    <hr />
    <div>
    <h4 class="hpagetxt text-left" >最新收藏</h4>
    <h4 class="hpagetxt text-right" style="color:#9fa0a0"><a href="/user/collection">查看更多</a></h4>
    <div class="clearfix"></div>
    </div>
    
    <div class="hpage2">
    <?php if(is_array($data["fav"])): $i = 0; $__LIST__ = $data["fav"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hpagepic" style="width:auto;"><a href="/index/detail?id=<?php echo ($vo["productid"]); ?>" target="_blank"><img src="<?php echo ($vo["imgurl"]); ?>" height="100%" /></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
    <div class="clearfix"></div>
    </div>
     <br /><br /><br /><br />
    <hr />
    <div>
    <h4 class="hpagetxt text-left" >浏览记录</h4>
   
    <div class="clearfix"></div>
    </div>
    
    <div class="hpage2" style="overflow: hidden;">
    <?php if(is_array($data["visit"])): $i = 0; $__LIST__ = $data["visit"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hpagepic" style="width:auto;"><a href="/index/detail?id=<?php echo ($vo["productid"]); ?>" target="_blank"><img src="<?php echo ($vo["imgurl"]); ?>" height="100%" /></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
    <div class="clearfix"></div>
    </div>
