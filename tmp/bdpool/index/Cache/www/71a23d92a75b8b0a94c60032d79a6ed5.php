                ...
                <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list3 float ff<?php echo ($vo["id"]); ?>">
                        <div class="list3 float">
                            <div class="list32 float">
                                <div<?php if($vo['show']): ?> onclick="location='/camerist/collection_list?uid=<?php echo I('get.uid');?>&id=<?php echo ($vo["id"]); ?>';"
                                    <?php endif; ?> style="cursor:pointer;width:100%; height:272px;background:url(<?php echo ($vo["topimg"]); ?>);background-position: center;background-size:cover;border-bottom:1px solid #eeeff2;" ></div>
