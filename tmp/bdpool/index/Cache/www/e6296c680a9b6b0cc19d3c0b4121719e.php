...
<div class="wrapper photographer" style="border-bottom: 1px solid #eee;">
    <div class="container" style="width: 100%;">
        <div class="photographer-nav row" style="position:relative;">
            ...
            <?php endif; ?>
                <div class="ula col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <ul>
    ...
    <div class="fans">
        <div class="fans-list clearfix">
            <div class="fans-margin">
                <?php if(is_array($data["fans"])): $i = 0; $__LIST__ = $data["fans"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vofans): $mod = ($i % 2 );++$i;?><div class="list float">
                        <a target="_blank" href="/camerist/gallery?uid=<?php echo ($vofans["id"]); ?>">
                            <div class="float"><img src="/static/<?php if($vofans['avatar']) echo 'uploadfiles/images/'.$vofans['avatar'];else echo 'images/tx.png'; ?>" width="70" style="border-radius:35px;" /></div>
                            <div class="float" style="margin:5px;">
                                <div style="font-size:16px;width:110px;white-space:nowrap;text-overflow:ellipsis;"><?php echo cstr($vofans['nickname'],'匿名');?></div>
                                <div style="margin:10px 0;color:#888;"><?php echo ($vofans["fans_count"]); ?>&nbsp;粉丝</div>
                                <div><?php echo ($vofans["img_count"]); ?>&nbsp;作品</div>
                            </div>
                        </a>
                        <?php if($vofans['id']!=$data['user']['id']){ ?><span onClick="fouc(<?php echo ($vofans["id"]); ?>)" style="float: right;" class="<?php if($vofans['followed']==1) echo 'fansbtn_2'; else echo 'fansbtn'; ?>"><?php if($vofans['followed']==1) echo '取消关注';else echo '关注'; ?></span>
                        <?php } ?>
