        ...
        <div class="photographer-nav" style="position:relative;">
            <div class="float">
                ...
                <div class="float" style="margin:5px;">
                    ...
                    <div class="clearfix" style="color:#7e7e7e;padding:10px 0;">个性签名：
...
<div class="wrapper">
    <div class="fans">
        <div class="fans-list clearfix">
            <div class="fans-margin">
                <?php if(is_array($data["followers"])): $i = 0; $__LIST__ = $data["followers"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vofollowers): $mod = ($i % 2 );++$i;?><div class="list float">
                        <a target="_blank" href="/camerist/gallery?uid=<?php echo ($vofollowers["id"]); ?>">
                            <div class="float"><img src="/static/<?php if($vofollowers['avatar']) echo 'uploadfiles/images/'.$vofollowers['avatar'];else echo 'images/tx.png'; ?>" width="70" style="border-radius:35px;" /></div>
                            <div class="float" style="margin:5px;">
                                <div style="font-size:18px;white-space:nowrap;width:110px; overflow:hidden; text-overflow:ellipsis;"><?php echo cstr($vofollowers['nickname'],'匿名');?></div>
                                <div style="margin:10px 0;color:#868b8f;font-size:16px;"><?php echo ($vofollowers["fans_count"]); ?>&nbsp;粉丝</div>
                                <div><?php echo ($vofollowers["img_count"]); ?>&nbsp;作品</div>
                            </div>
                            <?php if($vofollowers['id']!=$data['user']['id']){ ?><span onClick="fouc(<?php echo ($vofollowers["id"]); ?>)" style="float: right;" class="<?php if($vofans['followed']==1) echo 'fansbtn_2'; else echo 'fansbtn'; ?>"><?php if($vofollowers['followed']==1) echo '取消关注';else echo '关注'; ?></span>
                            <?php } ?>
                        </a>
